...
public class StatisticsService {
    ...
    public StatisticsOutputObject processInfo(StatisticsInputObject statisticsInputObject) {

        return doSomeStuff(statisticsInputObject.getConcept1(), statisticsInputObject.getConcept2());
    }


    private StatisticsOutputObject doSomeStuff(String concept1, String concept2)
    {
