package tanasageorgeandrei.dictionaryaccesspoint;
...
public class DictionaryAccessPoint {
     ...
     * @param lineBreak The lin separator string
     * @return A string containing all the definition from the API for a given word
     * @throws MalformedURLException
     * @throws ProtocolException
     * @throws IOException
     */
    public String getDefinitions(String word, String lineBreak) throws MalformedURLException, ProtocolException, IOException {
        ...
        for (int i = 0; i < meanings.length(); i++) {
            ...
            for (int j = 0; j < meanings.getJSONObject(i).getJSONArray("definitions").length(); j++) {
                ...
                temp.append(meanings.getJSONObject(i).getJSONArray("definitions").getJSONObject(j).getString("definition"));
                temp.append(lineBreak);
